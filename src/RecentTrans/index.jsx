         ...
         { catarr.map((x)=>{
            return(
                ...
                <section className='flex justify-between py-3'>
                    <div className='text-black flex gap-2'> <section className='flex justify-center items-center'> <img src={shopping} alt="" srcset="" /> </section> <section className='flex flex-col'> <span className='text-[#292B2D] text-base font-medium'>{x.label[0]}</span><span className='text-[#91919F] font-medium text-[13px] pt-2'>{x.description}</span></section></div>
