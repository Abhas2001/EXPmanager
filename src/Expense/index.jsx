...
const index = ({setnegarr,setImgLinks, setChange, change, storedarr, setStorednegArr }) => {
 ...
 console.log("TODAY",now.getDate());
  ...
  const handleCont = () => {
    ...
    finalval.push(val);
    setnegarr((prev)=>[...prev, {"label":dropdownarr,"input":val,"description":Input,"time":now.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: false }),"CurrentD":now.getDate()}])
    navigate("/home");
  };
